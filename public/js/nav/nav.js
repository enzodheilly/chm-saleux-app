document.addEventListener('DOMContentLoaded', () => {
    ...
    // ✅ Init : toutes les subpages sont aria-hidden au départ
    ...
    const closeSubpages = () => {
        ...
        subpages.forEach(p => {
            ...
            p.setAttribute('aria-hidden', 'true'); // ✅ masqué = inaccessible
        });
    };
    ...
    if (hamburger && overlay) {
        ...
        overlay.addEventListener('click', (e) => {
            ...
            if (trigger) {
                ...
                target.removeAttribute('aria-hidden'); // ✅ visible = accessible

                // ✅ Focus sur le bouton retour pour l'accessibilité
            ...
            if (back) {
                ...
                // ✅ Remettre le focus sur le trigger qui avait ouvert la subpage
                const openedBy = overlay.querySelector('.mobile-subpage-trigger');
