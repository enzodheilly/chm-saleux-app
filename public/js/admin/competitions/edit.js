// public/js/admin/competitions/edit.js

document.addEventListener('DOMContentLoaded', function () {

    // --- Confirmation suppression compétition ---
    ...
    function matchRowsToIds() {
        document.querySelectorAll('.js-athlete-select').forEach(function (select) {
            ...
            if (initLN && initFN) {
                const found = allAthletes.find(function (a) {
                    return getLastName(a).trim().toLowerCase() === initLN &&
                           getFirstName(a).trim().toLowerCase() === initFN;
                });
                if (found) select.dataset.selectedId = found.id;
            }
        });
    }
    ...
    function renderDropdowns() {
        ...
        document.querySelectorAll('.js-athlete-select').forEach(function (select) {
            ...
            allAthletes.forEach(function (a) {
                ...
                if (teamType === 'male') {
                    matchTeam = ['m', 'h', 'homme', 'masculin', 'male'].some(function (s) { return g.includes(s); });
                } else if (teamType === 'female') {
                    matchTeam = ['f', 'femme', 'feminin', 'female'].some(function (s) { return g.includes(s); });
                }
    ...
    function addRow() {
        ...
        tr.innerHTML =
            '<td><select class="js-athlete-select athlete-select-bold"></select></td>' +
    ...
    genderSelect.addEventListener('change', function () {
        document.querySelectorAll('.js-athlete-select').forEach(function (s) {
            s.value = '';
