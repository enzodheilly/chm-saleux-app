<?php
// src/Controller/Admin/AdminBackupController.php
...
class AdminBackupController extends AbstractController
{
    ...
    public function create(): Response
    {
        ...
        // 1️⃣ DB backup via PDO (no mysqldump)
    ...
    private function addFolderToZip(string $folder, ZipArchive $zip, string $parentFolder = ''): void
    {
