...
class getSchebTwoFactor_ProviderInitiatorService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.provider_initiator'] = $container->createProxy('TwoFactorProviderInitiatorGhostD4d0c1b', static fn () => \TwoFactorProviderInitiatorGhostD4d0c1b::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
