...
class getSchebTwoFactor_Security_Google_DefaultFormRendererService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.security.google.default_form_renderer'] = $container->createProxy('DefaultTwoFactorFormRendererGhost3ca88ab', static fn () => \DefaultTwoFactorFormRendererGhost3ca88ab::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
