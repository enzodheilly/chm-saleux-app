...
class getSchebTwoFactor_IpWhitelistConditionService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.ip_whitelist_condition'] = $container->createProxy('IpWhitelistConditionGhost1bc669f', static fn () => \IpWhitelistConditionGhost1bc669f::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
