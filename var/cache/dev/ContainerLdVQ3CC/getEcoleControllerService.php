...
class getEcoleControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/EcoleController.php';

        $container->services['App\\Controller\\EcoleController'] = $instance = new \App\Controller\EcoleController();

        $instance->setContainer(($container->privates['.service_locator.EmKNLkt'] ?? $container->load('get_ServiceLocator_EmKNLktService'))->withContext('App\\Controller\\EcoleController', $container));
