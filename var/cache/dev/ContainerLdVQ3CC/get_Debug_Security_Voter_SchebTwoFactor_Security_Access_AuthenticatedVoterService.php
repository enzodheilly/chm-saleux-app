...
class get_Debug_Security_Voter_SchebTwoFactor_Security_Access_AuthenticatedVoterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \Scheb\TwoFactorBundle\Security\Authorization\Voter\TwoFactorInProgressVoter(), $a);

        if (isset($container->privates['.debug.security.voter.scheb_two_factor.security.access.authenticated_voter'])) {
            return $container->privates['.debug.security.voter.scheb_two_factor.security.access.authenticated_voter'];
        }

        return $container->privates['.debug.security.voter.scheb_two_factor.security.access.authenticated_voter'] = $instance;
    }
}
