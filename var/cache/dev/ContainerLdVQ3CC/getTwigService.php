...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Twig/FileSizeExtension.php';
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/maker-bundle/templates'), '!Maker');
        $a->addPath((\dirname(__DIR__, 4).'/templates/bundles/SchebTwoFactorBundle'), 'SchebTwoFactor');
        ...
        $instance->addExtension(new \App\Twig\FileSizeExtension());
        ...
        $instance->addGlobal('turnstile_site_key', $container->getEnv('TURNSTILE_SITE_KEY'));
