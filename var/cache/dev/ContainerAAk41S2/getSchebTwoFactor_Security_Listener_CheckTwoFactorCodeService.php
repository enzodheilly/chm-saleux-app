...
class getSchebTwoFactor_Security_Listener_CheckTwoFactorCodeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Scheb\TwoFactorBundle\Security\Http\EventListener\CheckTwoFactorCodeListener(($container->privates['scheb_two_factor.provider_preparation_recorder'] ?? self::getSchebTwoFactor_ProviderPreparationRecorderService($container)), $a, $b);

        if (isset($container->privates['scheb_two_factor.security.listener.check_two_factor_code'])) {
            return $container->privates['scheb_two_factor.security.listener.check_two_factor_code'];
        }

        return $container->privates['scheb_two_factor.security.listener.check_two_factor_code'] = $instance;
    }
}
