...
class getSchebTwoFactor_ConditionRegistryService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.condition_registry'] = $container->createProxy('TwoFactorConditionRegistryGhost8449c2a', static fn () => \TwoFactorConditionRegistryGhost8449c2a::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
