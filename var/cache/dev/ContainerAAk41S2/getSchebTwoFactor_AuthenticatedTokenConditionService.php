...
class getSchebTwoFactor_AuthenticatedTokenConditionService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.authenticated_token_condition'] = $container->createProxy('AuthenticatedTokenConditionGhost4d971e3', static fn () => \AuthenticatedTokenConditionGhost4d971e3::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
