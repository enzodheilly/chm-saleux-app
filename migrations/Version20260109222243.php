 ...
 */
final class Version20260109222243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `primary` ON event_attendees');
        $this->addSql('ALTER TABLE event_attendees ADD PRIMARY KEY (user_id, event_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON event_attendees');
        $this->addSql('ALTER TABLE event_attendees ADD PRIMARY KEY (event_id, user_id)');
    }
}
